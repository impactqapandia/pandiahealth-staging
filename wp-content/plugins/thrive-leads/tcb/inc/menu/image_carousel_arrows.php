...
?>
<div id="tve-image_carousel_arrows-component" class="tve-component" data-view="ImageCarouselArrows">
	...
	<div class="dropdown-content">
		...
		<button class="tve-ghost-green-button click mb-5" data-fn="customizeArrows"><?php echo __( 'Customize arrow style', 'thrive-cb' ); ?></button>
	</div>
</div>
