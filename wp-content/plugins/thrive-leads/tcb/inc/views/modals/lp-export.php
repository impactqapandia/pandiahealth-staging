...
<span class="tcb-modal-title m-0"><?php echo __( 'Export Template', 'thrive-cb' ) ?></span>
...
<div class="tve-template-image">
	...
	<div class="thumbnail-preview choose-image">
		<div class="thumbnail-text">
			<span>
				<?php echo __( 'Click to upload a photo.', 'thrive-cb' ); ?>
			</span>
			<span>
		...
		<button type="button" class="tve-button remove-image"><?php tcb_icon( 'trash-light' ); ?><?php echo __( 'Remove', 'thrive-cb' ) ?></button>
	</div>
