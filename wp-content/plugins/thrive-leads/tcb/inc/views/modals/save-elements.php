...
<div class="tcb-modal-save-content">
	<span class="tcb-modal-title"><?php echo __( 'Save Element for Later Use', 'thrive-cb' ) ?></span>
...
<div class="tcb-modal-footer">
	<span class="tcb-show-templates">
		<a class="click" data-fn="show_templates">
			...
			<span class="tcb-hide-templates-label" style="color: #0c81bf"><?php echo __( 'Hide all Saved Templates', 'thrive-cb' ) ?></span>
		</a>
	</span>
