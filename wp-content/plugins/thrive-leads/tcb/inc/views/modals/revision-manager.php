...
?>
<h2 class="tcb-modal-title ml-0"><?php echo __( 'Revision Manager', 'thrive-cb' ) ?></h2>
<p class="tcb-modal-description mb-0"><?php echo __( 'Use the revision manager to restore your page to a previous version:', 'thrive-cb' ); ?></p>
...
<div class="tcb-modal-footer tcb-modal-footer pl-0 pr-0 pt-0">
	...
	<div>
		<button type="button" class="tcb-right tve-button medium green white-text tcb-modal-cancel"><?php echo __( 'Close', 'thrive-cb' ) ?></button>
	</div>
</div>
