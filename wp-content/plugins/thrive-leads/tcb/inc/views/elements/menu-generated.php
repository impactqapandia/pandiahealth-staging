...
$attributes = array(
	...
	'background_hover' => isset( $_POST['background_hover'] ) ? sanitize_text_field( $_POST['background_hover'] ) : '',
	'main_hover'       => isset( $_POST['main_hover'] ) ? sanitize_text_field( $_POST['main_hover'] ) : '',
	'child_hover'      => isset( $_POST['child_hover'] ) ? sanitize_text_field( $_POST['child_hover'] ) : '',
