		...
		<div class="tve_post_lightbox wrp cnt bSe">
			<article>
				<div class="tve_p_lb_background tve-scroll">
					<div class="tcb-lp-lb tve_editable tve_p_lb_content<?php echo $config['content']['class']; ?>"
						...
						<a href="javascript:void(0)"
						   class="tve_p_lb_close<?php echo $config['close']['class']; ?>"
						   style="<?php echo $config['close']['css']; ?>"<?php echo $config['close']['custom_color']; ?>
						   title="<?php echo __( 'Close', 'thrive-cb' ); ?>">x</a>
					</div>
