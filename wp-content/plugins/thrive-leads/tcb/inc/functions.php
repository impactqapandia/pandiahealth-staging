...
function tve_load_custom_css( $post_id = null ) {
	...
	if ( $posts_to_load ) {
		...
		if ( ! empty( $inline_styles ) ) {
			...
			?>
			<style class="tve_custom_style"><?php echo $inline_styles; ?></style>
			<?php
		}
...
function tcb_print_frontend_styles() {
	...
	if ( ! tve_dash_is_google_fonts_blocked() ) {
		if ( TCB\Lightspeed\Fonts::is_enabled() ) {
			TCB\Lightspeed\Fonts::parse_google_fonts( implode( ';', $font_imports ) );
		} else {
