...
if ( ! empty( $args['name'] ) && false !== $has_shortcode ) : ?>
	<br>
	<b><?php echo ! empty( $labels['name'] ) ? $labels['name'] . ':' : __( 'Name:', TVE_DASH_TRANSLATE_DOMAIN ); ?> </b> <span> <?php echo $args['name']; ?> </span>
<?php endif; ?>

<?php if ( false !== $has_shortcode ) : ?>
	<br>
	<b><?php echo ! empty( $labels['email'] ) ? $labels['email'] . ':' : __( 'Email:', TVE_DASH_TRANSLATE_DOMAIN ); ?></b> <span> <?php echo $args['email']; ?> </span>
<?php endif; ?>

<?php if ( ! empty( $args['phone'] ) && false !== $has_shortcode ) : ?>
	<br>
	<b><?php echo ! empty( $labels['phone'] ) ? $labels['phone'] . ':' : __( 'Phone:', TVE_DASH_TRANSLATE_DOMAIN ); ?></b> <span> <?php echo $args['phone']; ?> </span>
<?php endif; ?>
