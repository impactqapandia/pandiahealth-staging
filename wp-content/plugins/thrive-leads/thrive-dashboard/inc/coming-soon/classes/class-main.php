...
class Main {
	...
	public static function get_page_id() {
		return get_option( 'tvd_coming_soon_page_id', 0 );
	}
	...
	public static function get_page_name() {
		return get_the_title( self::get_page_id() );
	}
	...
	public static function get_edit_url() {
		return tcb_get_editor_url( self::get_page_id() );
	}
	...
	public static function get_preview_url() {
		return get_permalink( self::get_page_id() );
	}
	...
	public static function is_empty_page() {
		...
		if ( self::get_page_id() && tve_get_post_meta( self::get_page_id(), 'tve_updated_post' ) ) {
			$empty_page = false;
		}
