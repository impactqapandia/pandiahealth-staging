...
<section class="hp-section redesign" id="how_it_works">
    <div class="container redesign">
        <div class="row">
            <div class="col text-center">
                <h2 class="title hiw-title"><a href=""></a></h2>
                                    <p class="sub-title">Meet our CEO &amp; Co-founder, Sophia Yen MD, MPH MIT, UCSF, UCB Stanford Clinical Associate Professor</p>
                            </div>
        </div>
        <div class="row">
            <div class="col">
