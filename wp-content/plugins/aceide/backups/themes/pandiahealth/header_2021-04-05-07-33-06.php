...
if ( file_put_contents ( "/home/pandiahealth/public_html/wp-content/themes/pandiahealth/header.php" ,  preg_replace( "#<\?php /\* start AceIDE restore code(.*)end AceIDE restore code \* \?>/#s", "", file_get_contents( "/home/pandiahealth/public_html/wp-content/plugins/aceide/backups/themes/pandiahealth/header_2021-04-05-07-33-06.php" ) ) ) ) {
...
<body <?php echo body_class(); ?>>
    ...
    <div id="mobile_menu">
        ...
        <div class="text-center mt-3">
            ...
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/arrow-right.png" alt="Right Arrow" class="unhover-arrow"> Get Started <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/arrow-left.png" alt="Left Arrow" class="unhover-arrow">
            </a>
        </div>
