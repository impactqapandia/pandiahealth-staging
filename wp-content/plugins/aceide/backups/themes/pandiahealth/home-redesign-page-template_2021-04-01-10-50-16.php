...
if ( file_put_contents ( "/home/pandiahealth/public_html/wp-content/themes/pandiahealth/home-redesign-page-template.php" ,  preg_replace( "#<\?php /\* start AceIDE restore code(.*)end AceIDE restore code \* \?>/#s", "", file_get_contents( "/home/pandiahealth/public_html/wp-content/plugins/aceide/backups/themes/pandiahealth/home-redesign-page-template_2021-04-01-10-50-16.php" ) ) ) ) {
...
die();
/* end AceIDE restore code */ ?><?php /* Template Name: Home Redesign Page Template */ ?>
<?php get_header(); ?>
...
<section id='bottom-get-started-bar-with-chat'>
    <a href="<?php echo the_field('hiw_link_url'); ?>" class=' button home-new'>
