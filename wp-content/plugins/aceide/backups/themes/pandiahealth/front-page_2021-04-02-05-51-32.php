...
<section id='bottom-get-started-bar-with-chat'>
    <a href="<?php echo the_field('hiw_link_url'); ?>" class='get-started-link button button-4'>
    <img alt="Right Arrow" src="https://www.pandiahealth.com/wp-content/themes/pandiahealth/img/arrow-right.png" class="unhover-arrow new-my">
        <span><?php echo the_field('hiw_link_text'); ?></span>
    <img alt="Right Arrow" src="https://www.pandiahealth.com/wp-content/themes/pandiahealth/img/arrow-left.png" class="unhover-arrow new-my">
    </a>
