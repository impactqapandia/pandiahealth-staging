...
class Advanced_Form_Integration
{
    ...
    public function includes()
    {
        ...
        include ADVANCED_FORM_INTEGRATION_PLATFORMS . '/asana/asana.php';
        ...
        include ADVANCED_FORM_INTEGRATION_PLATFORMS . '/benchmark/benchmark.php';
        ...
        include ADVANCED_FORM_INTEGRATION_PLATFORMS . '/slack/slack.php';
