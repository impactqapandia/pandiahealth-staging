        ...
        <form name="zohocampaigns_save_form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>"
            ...
            <table class="form-table">
                ...
                <tr valign="top">
                    ...
                    <td>
                        <p>
                            <?php _e( '1. Go to <a target="_blank" rel="noopener noreferrer" href="https://api-console.zoho.com/">ZOHO API Console</a> and create an <b>OAuth App</b><br>', 'advanced-form-integration' ); ?>
