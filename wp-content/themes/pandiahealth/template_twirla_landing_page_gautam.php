<?php 
/* Template Name: Twirla Landing Page Gautam */
get_header(); ?>
<style>
...
.savings-section{ background-color: #CBE4F3; background-image: url('<?php echo get_template_directory_uri(); ?>/img/twirla/savings-bg.jpg'); background-repeat: no-repeat;}
			 ...
			 <h1 class="hero-title">Say "hello" to Twirla <br>and "goodbye" to daily <br>birth control</h1>
				<div class="hero-desc">
				 ...
				 <div class="sectionCTA d-none d-md-block">
					<a href="#!" class="custom-button" target="_blank">Get Started</a>
				 </div>
			 </div>
		  </div>
	   </div>
        ...
        <div class="row">
		    <div class="col-lg-6 offset-lg-3">
				<div class="small-wrapper">
					<h3 class="sub-heading">Claim More</h3>
    ...
    <div class="container">
		...
		<div class="row">
			<div class="col-md-6 col-lg-5 offset-lg-1 saving-item">
				<div class="content-wrap">
					<p>You could pay as little as $0 for your first month of Twirla with insurance.</p>
				</div>
			</div>
	...
	<div class="small-container">
		<div class="container">
			<div class="row align-items-center">
				...
				<div class="col-md-8 devider-line">
					<div class="prescription-wrap">
						<div class="prescription-item">
							<img src="<?php echo get_template_directory_uri(); ?>/img/twirla/cost-icon.png">
							<p>Fill out health from ($20 Fee)</p>
			...
			<div class="col-md-12 order-md-12">
				...
				<table class="table-striped table-responsive text-center">
					...
					<tbody>
						...
						<tr>
							<td></td>
							<td><strong>Price without insurance</strong></td>
							<td></td>
						</tr>
						<tr>
							<td>$50/month</td>
						...
						<tr>
							<td></td>
							<td><strong>Type of birth control</strong></td>
							<td></td>
						</tr>
						<tr>
						...
						<tr>
							<td></td>
							<td><strong>Number of yearly deliveries</strong></td>
							<td></td>
						</tr>
