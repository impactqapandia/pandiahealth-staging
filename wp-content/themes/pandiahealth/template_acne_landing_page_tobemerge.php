<?php 
/* Template Name: Acne Landing to be Merge */
get_header('acne'); ?>
<style>
...
.section-subttile2{font-size: 16x; padding-bottom:20px;line-height:26px;} 
...
.faq-section.redesign p.question{font-weight: 700;}


.klaviyo-form-W7pzYT{width: 60%;}
.klaviyo-form-W7pzYT input{border-radius:100px;background-color:none !important; background:none !important; border:none !important;}
...
.klaviyo-form-W7pzYT button{background-color: #fff !important; color: #2D99CE !important;border-radius: 100px !important;padding:11px 30px !important; font-family: 'Montserrat', sans-serif !important; display: inline-flex; align-items: center; justify-content: center;}
...
.gBKwYK.gBKwYK{background-color: rgb(45, 153, 206);border-radius:100px; overflow: visible;}
...
.faq-questions .ui-widget-content a.custom-button{color:#fff !important}
...
tr:first-child td:first-child { border-bottom-left-radius: 100px; }

tr:first-child td:last-child { border-top-right-radius: 100px; }
tr:first-child td:last-child { border-bottom-right-radius: 100px; }

tr:last-child td:first-child { border-bottom-left-radius: 100px; }
tr:last-child td:first-child { border-top-left-radius: 100px; }

tr:last-child td:last-child { border-bottom-right-radius: 100px; }
tr:last-child td:last-child { border-top-right-radius: 100px; } */
...
@media(max-width:1024px){
   ...
   .how-ul {margin-bottom: 94px; margin-top: 110px;	}
}
...
#banner_cta.redesign{width: auto !important; margin-left: 100px !important;margin-right:100px !important; box-shadow: none !important; margin-bottom: 10px !important; }
...
.pres-need { text-align: center; font-weight: 600; font-size: 24px; }
...
.how-ul{ margin-bottom: 104px;  margin-top: 102px;}
...
table .tbl-subHead{font-size:9px;}
...
.section-subttile2 { font-size: 16px; padding-bottom: 20px; line-height: 26px; }
...
@media only screen and (max-width: 600px) {
   ...
   .bg-white-btn{display:none;}
   #banner_cta.redesign{margin-left: 25px !important; margin-right: 25px !important;margin-top: 250px;}

   .hero-section, .mHero-section{ background-image: url('<?php echo get_template_directory_uri(); ?>/img/acne-page/acne-banner-mobile.png'); background-repeat: no-repeat; background-position: center center; background-size: cover; padding:2rem 0; }
   .hero-content{float:none;position:relative;top:230px;}
   ...
   .ctaOnly{height:auto;}
   .ctaOnly .sectionCTA { position: fixed; top:65%; right: 0; left: 0;bottom:0; z-index: 10;}
   .float-mobile{  -moz-box-shadow:2px 10px 18px #00000; -webkit-box-shadow: 2px 10px 18px #000; box-shadow:2px 10px 18px #000;}
   .how-it-wrapper{padding-top: 20px; padding-bottom: 40px;}
   ...
   .section-subttile2{font-size: 14px;}


.klaviyo-form-W7pzYT{width: 100%;}
.klaviyo-form-W7pzYT input{border-radius:100px;border:1px solid #ccc;}
...
.iAMCek.iAMCek{border-radius:100px;}
.gBKwYK.gBKwYK{background-color:transparent;border-radius:0px;}
                  ...
                  <ul class="list-group vertical-steps">
                     <li class="list-group-item completed">
                        <div class="step-wrapper">
                           ...
                           <span>Take photos of problem areas &amp; <br>upload on our HIPAA compliant <br>and encrypted website.</span>
                        </div>
                     </li>
                     <li class="list-group-item completed">
						<div class="step-wrapper">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 text-center">
			  ...
			  <p class="prescription-txt">Our online board certified doctors evaluate your skin and provide quality<br> prescription grade acne medication delivered straight to your mailbox.</p>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6 col-lg-11" style="margin:0 auto; padding-top: 1.5rem;">
				...
				<table class="table table-striped text-center mb-0 mt-3">
					<thead>
						<tr>
							<th scope="col"><a href="https://www.pandiahealth.com/tretinoin-before-after-benefits-of-retin-a-for-acne-aging/" class="d-none d-lg-block">Topical Medication</a><span class="d-block d-md-block d-lg-none">Medication</span></th>
					...
					<tbody>
						<tr>
							<td><a href="https://www.nurx.com/antibiotic/clindamycin/" target="_blank">Clindamycin phosphate lotion</a></td>
						...
						<tr class="evenRow">
							<td><a href="https://www.nurx.com/antibiotic/clindamycin/" target="_blank">Benzaclin gel</a></td>
							<td><img src="<?php echo get_template_directory_uri(); ?>/img/acne-page/check-mark.png" width="30" height="30" alt="check-mark" class="tickImg" /></td>
							<td class="price"><strong>$35</strong> <span class="md">/MONTH</span></td>
						</tr>
						<tr>
							<td><a href="https://www.nurx.com/antibiotic/clindamycin/" target="_blank">Tretinoin cream</a></td>
							<td><img src="<?php echo get_template_directory_uri(); ?>/img/acne-page/check-mark.png" width="30" height="30" alt="check-mark" class="tickImg" /></td>
			...
			<div class="col-md-6 col-lg-11" style="margin:0 auto; padding-top: 1.5rem;">
				...
				<table class="table table-striped text-center mt-3 mb-0">
					<thead>
						<tr>
							<th scope="col"><a href="https://www.pandiahealth.com/resources/what-are-acne-oral-antibiotics/" class="d-none d-lg-block">Oral Medication</a><span class="d-block d-md-block d-lg-none">Medication</span></th>
							<th scope="col">Insurance Price <br><span class="tbl-subHead" style="font-weight:400;">copay + deductible*</span></th>
							<th scope="col">Out-of-Pocket Price <br><span class="tbl-subHead" style="font-weight:400;">as low as</span></th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td><a href="https://www.nurx.com/antibiotic/clindamycin/" target="_blank">Antibiotics</a></td>
							<td><img src="<?php echo get_template_directory_uri(); ?>/img/acne-page/check-mark.png" width="30" height="30" alt="check-mark" class="tickImg" /></td>
							<td class="price"><strong>$40</strong> <span class="md">/MONTH</span></td>
						</tr>
						<tr class="evenRow">
							<td><a href="https://www.nurx.com/antibiotic/clindamycin/" target="_blank">Spironolactone</a></td>
							<td><img src="<?php echo get_template_directory_uri(); ?>/img/acne-page/check-mark.png" width="30" height="30" alt="check-mark" class="tickImg" /></td>
							<td class="price"><strong>$30</strong> <span class="md">/MONTH</span></td>
						</tr>
						<tr>
							<td><a href="https://www.nurx.com/antibiotic/clindamycin/" target="_blank">Birth control pills</a></td>
							<td><img src="<?php echo get_template_directory_uri(); ?>/img/acne-page/check-mark.png" width="30" height="30" alt="check-mark" class="tickImg" /></td>
...
<section class="section-padding tabletSection d-lg-none d-xl-none" style="background-color:#D0EBF6;">
<div class="container">
<div class="row">
   <div class="col-md-12 text-center">
      <h2 class="section-heading">Prescription grade acne treatment</h2>
      ...
      <div class="col-md-6">
    		    <div class="card profile-card-5">
    		        <div class="card-img-block">
    		            <img class="card-img-top" src="<?php echo get_template_directory_uri(); ?>/img/acne-page/topical-acne-treatment.jpg" alt="Card image cap">
    		        </div>
                    <div class="card-body pt-3">
                    <h5 class="card-title"><a href="https://www.pandiahealth.com/tretinoin-before-after-benefits-of-retin-a-for-acne-aging/">Topical acne treatment</a></h5>
                    <p class="card-text">Mild & moderate acne is best treated with prescription topical acne medication. Topical acne medication works by killing Acne bacteria and “normalizing” the skin (less greasy & smaller pores).</p>
         

                  </div>
            <div class="table-tablet">
               <table class="table text-center">
                  <thead>
                     <tr>
                        <th scope="col">Medication</th>
                        <th scope="col">Insurance Price <span class="tbl-subHead" style="display:block;font-weight:300;">copay + deductible*</span></th>
                        <th scope="col">Out-of-Pocket Price <span class="tbl-subHead" style="display:block;font-weight:300;">As low as </span></th>
                     </tr>
                  </thead>
                  <tbody>
                     <tr class="bg-acne">
                        <td><a href="https://www.nurx.com/antibiotic/clindamycin/">Clindamycin phosphate lotion</a></td>
                        <td><img src="<?php echo get_template_directory_uri(); ?>/img/acne-page/check-mark.png" width="30" height="30" alt="check-mark" class="tickImg" /></td>
                        <td class="price"><strong>$20</strong> <span class="md">/MONTH</span></td>
                     </tr>
                     <tr>
       ...
       <div class="col-md-6">
    		    <div class="card profile-card-5">
    		        <div class="card-img-block">
    		            <img class="card-img-top" src="<?php echo get_template_directory_uri(); ?>/img/acne-page/oral-acne-treatment.jpg" alt="Card image cap">
    		        </div>
                    <div class="card-body pt-3">
                    <h5 class="card-title"><a href="https://www.pandiahealth.com/resources/what-are-acne-oral-antibiotics/">Oral acne treatment</a></h5>
                    <p class="card-text">Moderate and severe acne is treated with prescription oral and topical acne medication. Oral antibiotics work by attacking acne bacteria from the inside out and decreasing inflammation.</p>
...
<section class="section-padding medsOnline" style="background-color:<?php echo get_sub_field('background_color'); ?>">
	<div class="container">
		<div class="row">
      <h2 class="section-heading mx-auto d-lg-none d-xl-none d-none d-sm-block"><a href="https://www.pandiahealth.com/about#sectionour_doctors"><?php echo get_sub_field('section_heading'); ?></a></h2>
            ...
            <div class="sectionCTA d-none d-md-block mt-4">   
               <a href="<?php echo get_sub_field('url'); ?>" class="custom-button" target="_blank"><?php echo get_sub_field('button_text'); ?></a>
            </div>
			</div>
        ...
        <div class="col-md-6">
            <div class="doctor-img">
                <a href="https://www.pandiahealth.com/about#sectionour_doctors"><img src="<?php echo get_template_directory_uri(); ?>/img/acne-page/doctors-comp2 1.png" alt=""></a>
